...
exports.getCompanyBankruptcy = function(req, success, error) {
    ...
    doBankruptcy(req, success, error, config, form, headers, parser.parseListHtml, parser.parseBankruptcyHtml);
};
